...
d_fits_32 <- nest(df32, data = c(Temp, Average_speed)) %>%
...
ggplot(d_preds, aes(Temp, Average_speed)) +
  geom_point(aes(Temp, Average_speed), df32) +
...
write.csv(d_ic, "d_ic_average_speed_A32.csv", sep = ",")
