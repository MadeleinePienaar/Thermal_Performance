...
#Load July warm spell data 
df <- read.csv("Spread_rate_Jul_warm_spell.csv", header = TRUE, sep=";")
...
#Plot July with warm spell distance travelled data (Grabouw)
...
#Plot temperature over time data for July with warm spell (Grabouw)
p6 <- ggplot()+
